...
Newp WordPress Theme, Copyright (C) 2016, InkHive.com
Newp is distributed under the terms of the GNU GPL v3
...
2. Upload the newp.zip file, in which you found this README.txt
3. Click on Install and Activate.
...
Newp is a relatively new theme, and could contain some hidden bugs. So, if you find any please report them at the following URL:
