 ...
 *
 * @uses newp_header_style()
 * @uses newp_admin_header_style()
 * @uses newp_admin_header_image()
 */
...
if ( ! function_exists( 'newp_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see newp_custom_header_setup().
 */
function newp_admin_header_style() {
?>
	<style type="text/css">
...
endif; // newp_admin_header_style

if ( ! function_exists( 'newp_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see newp_custom_header_setup().
 */
function newp_admin_header_image() {
